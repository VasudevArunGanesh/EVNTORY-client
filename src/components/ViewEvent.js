...
const { id } = useParams();
  ...
  return (
    <div className='view-page'>
        <Navbar links={[]} pfpicon={true} dropdown={[{text:"Profile", path:"/user/"+id},{text:"Log Out", path:"../"}]} buttons={[{text:"Create an Event",type:"danger", path:"/user/"+id+"/create-event"}]} bgcolor={"#444"} textcolor={"white"} linkto={"../user/"+user._id} username={user.name} logolink={"/user/"+user._id+"/home"}/>
        ...
        <div className='event-info'>
            ...
            <div className='event-footer'>
                <div className='event-footer-left'>
                    ...
                    <div className='ticket-button'><Button type='success' onClick={proceedToBooking}>Book Tickets</Button></div>
